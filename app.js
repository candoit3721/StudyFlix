...
const DEFAULT_PROFILES = [
  {
    ...
    topics: [
      ...
      { title: "🎢 Roller Coaster Physics", icon: "🚀", badge: "PHYSICS", desc: "Potential vs. Kinetic energy & Newton's 3 Laws", link: "sophia-science/index.html#tab-learn", bg: "linear-gradient(135deg, #8b5cf6, #3b82f6)" },
